...
$(document).ready(function() {
   $('#IDul_lowerWeekSelector01 li a, #IDul_lowerWeekSelector02 a, #IDul_upperWeekSelector01 a, #IDul_upperWeekSelector02 a').click(function(e) {
      ...
      var points_yes_no =  $('#IDi_points').attr('value');
      ...
      $.ajax ({
         ...
         timeout: 2000,
         async: true,
         data:  {   dothis: 'buildWeeklyStandings', buildMode: 'rows',         week: week_selected, 
                    league: league,                    player: userid,  pointsyesno: points_yes_no,
      ...
      $.ajax ({
         ...
         timeout: 2000,
         async: true,
         data:  {dothis: 'seasontable', week: week_selected, league: league},
         error: function() {
            alert("An error occurred.  Please try later." );
         },
         success: function(data) {
